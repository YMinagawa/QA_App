...
public class AnswerSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener{
    ...
    public void onClick(View v) {
        ...
        DatabaseReference answerRef = dataBaseReference.child(Const.ContentPATH).child(String.valueOf(mQuestion.getGenre()));
    ...
    //Firebaseへの書き込み完了を受け取るonCompleteメソッドでは成功したらfinishメソッドを呼び出して
    //Activityを閉じ、失敗した場合はSnackbarでその旨を表示する。
