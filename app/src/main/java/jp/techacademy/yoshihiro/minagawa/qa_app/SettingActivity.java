...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //表示名変更ボタンのクリックリスナーではログインしているかどうかを確認し、
        //もしログインしていなければSnackBarでその旨を表示して、その後は何もしない
        //ログインしていればFirebaseに表示名を保存し、Preferenceにも保存する。
        ...
        //ログアウトボタンのリスナーではログアウト処理を行う。
        //ログアウトはFirebaseAuthクラスのsignOutメソッドを呼び出す。
        //signOutメソッドを呼び出した後はPreferenceに空文字を保存しSnackbarでログアウト完了を示す
